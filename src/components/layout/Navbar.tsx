...
export function Navbar() {
    ...
    return (
        <nav className="bg-white px-4 md:px-8 pt-2 pb-4 border-b border-tdlInk/5">
            {/* Top Bar */}
            <div className="hidden md:flex justify-between items-center text-[10px] uppercase tracking-widest font-bold text-tdlInk/40 mb-3 border-b border-tdlInk/5 pb-2">
